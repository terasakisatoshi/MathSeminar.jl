...
<head>
  ...
  <!-- my theorem counter -->
  <link rel="stylesheet" href="/MathSeminar.jl/css/css_theorem.css">
  <link rel="stylesheet" href="/MathSeminar.jl/css/maththeorem.css">
    ...
    <nav class="sidebar-nav">
      <ul class="metismenu"  id="metismenu" >
        ...
        <li><a href="" class="has-arrow">Slide Show</a>
          <ul>
            <li><a href="/MathSeminar.jl/slideshow/tutorial/build/">Remark.jl</a>
            <li><a href="/MathSeminar.jl/slideshow/juliatokai/build">JuliaTokai</a>
          </ul>
        </li>
        ...
        <li><a href="" class="has-arrow">Topics in Mathematics</a>
          <ul>
            <li><a href="mathematics/linearalgebra/chapter0">Linear Algebra</a></li>
            <li><a href="mathematics/statistics/dice">Dice</a></li>
          </ul>
        </li>
      </ul>
    </nav>
...
<div class="page-foot">
  <div class="copyright">
    &copy; SatoshiTerasaki. Last modified: 1985年10月26日 土曜日. Website built with <a href="https://github.com/tlienart/Franklin.jl">Franklin.jl</a>.
  </div>
</div>
